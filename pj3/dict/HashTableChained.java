...
public void resize() {
    //System.out.println(this);
    DList[] temp;// = new HashTableChained(2);
    if (loadFactor() < 0.3) {
    ...
    //System.out.println(temp.numberOfBuckets);
    // System.out.println("old was: " + numberOfBuckets);
    // for (int i = 0; i < dict.length; i++) {
    //   if (dict[i].length() != 0) {
    //     DListNode front = dict[i].front();
    //     //System.out.println(i);
    //     int k = 0;
    //     while (front != null && front.next().item != null) {
    //       //System.out.println(k);
    //       //System.out.println(front.item);
    //       temp.insert(((Entry) front.item).key(), ((Entry) front.item).value()); //correct?
    //       front = front.next();
    //       k++;
    //     }
    //   }
        ...
        while(front != null) {
         ...
         // System.out.println("temp ");
          ...
          if (front.next().item() != null){
           ...
           // System.out.println("Didnt find any front.next() node");
            break;
          }
    ...
    this.dict = temp;
   // System.out.println("number after resize: " + numberOfBuckets);
}
  ...
  // public void resize() {
  //   //System.out.println(this);
  //   HashTableChained temp;// = new HashTableChained(2);
  //   if (loadFactor() < 0.3) {
  //     temp = new HashTableChained(numberOfBuckets/2);
  //   } else { //checking
  //     temp = new HashTableChained(numberOfBuckets*2);
  //   }
  //   System.out.println(temp.numberOfBuckets);
  ...
  //       while(front != null) {
  //        // System.out.println("temp ");
  //         temp.insert(((Entry) front.item).key(), ((Entry) front.item).value());
  //         if(front.next().item() != null){
  //           front = front.next();
  //         } else {
  //          // System.out.println("Didnt find any front.next() node");
  ...
  //   this.dict = temp;
  //   System.out.println(numberOfBuckets == temp.numberOfBuckets);
  //   //this.numberOfBuckets = temp.numberOfBuckets();
  //   //System.out.println("new is: " + numberOfBuckets);
  //   //this.size should be equal to temp size -- adding test here ---
